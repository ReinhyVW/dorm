...
import { getActionsByReporter } from "@/adapters/dataGetters/getActions";
...
export default function Meeting({ params }: { params: { userId: string } }) {
  ...
  React.useEffect(() => {
    async function loadData() {
      const rows: Actions[] = await getActionsByReporter(userId)
      setActions(rows)
